...
class Event{
  final String name,start_date_time,event_type,end_date_time,description, link_to_rulebook;
  ...
  Event(this.name,this.start_date_time,this.event_type,this.end_date_time,this.description,this.subcategory,
      ...
      ,this.minimum_team_size,this.maximum_team_size, this.link_to_rulebook);
